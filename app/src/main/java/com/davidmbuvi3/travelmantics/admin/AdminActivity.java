package com.davidmbuvi3.travelmantics.admin;
...
import com.davidmbuvi3.travelmantics.dealList.ListActivity;
import com.davidmbuvi3.travelmantics.models.TravelDeal;
            ...
            Task<Uri> urlTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(AdminActivity.this, "Picture couldn't be uploaded", Toast.LENGTH_LONG).show();
                    }
                }
            });
        }
